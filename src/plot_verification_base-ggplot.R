#Script to print out plots of verification metrics calculated in 'calc_ecrps-rankhist_base.R' script
...
shefs_ecrps_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-ecrps-vec.rds',sep=''))
hefs_ecrps_ss<-readRDS(paste('./data/',loc,'-',disp_site,'_pct=',disp_pcnt,'_hefs-ecrps-ss.rds',sep=''))
shefs_ecrps_ss<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-ecrps-ss.rds',sep=''))
hefs_rank_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pct=',disp_pcnt,'_hefs-rank-vec.rds',sep=''))
shefs_rank_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-rank-vec.rds',sep=''))
hefs_mse_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pct=',disp_pcnt,'_hefs-mse-vec.rds',sep=''))
shefs_mse_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-mse-vec.rds',sep=''))
hefs_sdev_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pct=',disp_pcnt,'_hefs-sdev-vec.rds',sep=''))
shefs_sdev_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-sdev-vec.rds',sep=''))
hefs_pbias_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pct=',disp_pcnt,'_hefs-pbias-vec.rds',sep=''))
shefs_pbias_vec<-readRDS(paste('./data/',loc,'-',disp_site,'_pcntile=',disp_pcnt,'_setup=',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-pbias-vec.rds',sep=''))
hefs_ecrps_pk<-readRDS(paste('./data/',loc,'-',disp_site,'_hefs-ecrps-peak10.rds',sep=''))
shefs_ecrps_pk<-readRDS(paste('./data/',loc,'-',disp_site,'_',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-ecrps-peak10.rds',sep=''))
hefs_ecrps_ss_pk<-readRDS(paste('./data/',loc,'-',disp_site,'_hefs-ecrps-ss-peak10.rds',sep=''))
shefs_ecrps_ss_pk<-readRDS(paste('./data/',loc,'-',disp_site,'_',cal_val_setup,'_pcnt=',opt_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'_shefs-ecrps-ss-peak10.rds',sep=''))
...
for(l in 1:dim(lds)[1]){
  ...
  ecrps_dt <- data.table(x=1,hefs=hefs_ecrps_vec[,lds[l,]],syn=shefs_ecrps_in)
...
ggsave(paste(path_out,loc,'-',disp_site,'_ecrps-bplots_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=4.5,height=6,unit='in')
...
for(l in 1:dim(lds)[1]){
  ...
  ecrps_dt <- data.table(x=1,hefs=hefs_ecrps_ss[,lds[l,]],syn=shefs_ecrps_in)
...
ggsave(paste(path_out,loc,'-',disp_site,'_ecrps-ss-bplots_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=4.5,height=6,unit='in')
...
for(l in 1:dim(lds)[1]){
  ...
  ecrps_dt <- data.table(x=1,hefs=hefs_mse_vec[,lds[l,]],syn=shefs_mse_in)
...
ggsave(paste(path_out,loc,'-',disp_site,'_mse-bplots_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=4.5,height=6,unit='in')
...
for(l in 1:dim(lds)[1]){
  ...
  ecrps_dt <- data.table(x=1,hefs=hefs_sdev_vec[,lds[l,]],syn=shefs_sdev_in)
...
ggsave(paste(path_out,loc,'-',disp_site,'_sdev-bplots_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=4.5,height=6,unit='in')
...
for(l in 1:dim(lds)[1]){
  ...
  ecrps_dt <- data.table(x=1,hefs=hefs_pbias_vec[,lds[l,]],syn=shefs_pbias_in)
...
ggsave(paste(path_out,loc,'-',disp_site,'_pbias-bplots_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=4.5,height=6,unit='in')


#########################################eCRPS plot for specific events##############################################
neval_evts = 10
eval_evts <- declust_evts_extract(obs_key,neval_evts,sep=15,max_lds = 14)
...
for(l in 1:neval_evts){
  ...
  ecrps_d2t <- data.table(x=1:leads-.25,hefs=hefs_ecrps_pk[l,])
  ...
  ecrps_bplt <- ggplot(df)+theme_minimal()+
    ...
    scale_color_manual(name='',breaks='hefs',labels=c(TeX('$HEFS$')),values=c(clrs[[1]]))+
    coord_cartesian(xlim=c(0,leads),ylim = c(0,1.05*max(ecrps_d2t$hefs)))+
    annotate('text',x=12,y=0.1*max(ecrps_d2t$hefs),label=ixx_eval[eval_evts[l]],size=4)+
...
ggsave(paste(path_out,loc,'-',disp_site,'_ecrps-bplots_top',neval_evts,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=12,height=5,unit='in')

#########################################eCRPS-SS plot for specific events##############################################
neval_evts = 10
eval_evts <- declust_evts_extract(obs_key,neval_evts,sep=15,max_lds = 14)
...
for(l in 1:neval_evts){
  ...
  ecrps_d2t <- data.table(x=1:leads-.25,hefs=hefs_ecrps_ss_pk[l,])
  ...
  ecrps_bplt <- ggplot(df)+theme_minimal()+
    ...
    annotate('text',x=12,y=0.9,label=ixx_eval[eval_evts[l]],size=4)+
    theme(axis.text.y=element_text(size=10),
...
ggsave(paste(path_out,loc,'-',disp_site,'_ecrps-ss-bplots_top',neval_evts,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),ecrps_gplot,dpi=320,width=12,height=5,unit='in')
...
ggsave(paste(path_out,loc,'-',disp_site,'_rankhist-lineplot_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),rank_gplot,dpi=320,width=9,height=7,unit='in')
...
ggsave(paste(path_out,loc,'-',disp_site,'_rankhist-shadeplot_pcntile=',disp_pcnt,'_objpwr=',obj_pwr,'_optstrat=',opt_strat,'.png',sep=''),shefs_gplot,dpi=320,width=9,height=7,unit='in')
